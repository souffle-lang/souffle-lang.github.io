...
Currently, we do not provide any packages for standard operating systems.

Please follow the build instructions to build and install Soufflé locally on your computer. 
